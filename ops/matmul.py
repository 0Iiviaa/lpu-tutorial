...
# Random tiling parameters for robustness testing.
...
def _aru_writeback_tile(isa, psb_m1n1m0n0, m_size, n_size):
    # ISA.aru always returns a list; gm output is the first element when gm_wr_en=True.
    return isa.aru(
        m_size,
        n_size,
        psb_m1n1m0n0=psb_m1n1m0n0,
        psb_rd_en=True,
        ub_m1n1m0n0=None,
        ub_rd_en=False,
        arb_in=None,
...
# Three-level tiled matmul: L2 -> L1 -> L0.
            ...
            for l0_n_start_in_l1 in range(0, n_size_l1, N_L0):
                ...
                for l0_m_start_in_l1 in range(0, m_size_l1, M_L0):
                    ...
                    for l1_k1_start_in_l2 in range(0, K1_L2, K1_L1):
                        ...
                        right_k1nk0_l1 = isa.gdma_mov2ub(
                            right_k1nk0_l2,
                            N_L2,
                            l1_n_start_in_l2,
                            K1_L2,
                        ...
                        for l0_k1_start_in_l1 in range(0, k1_size_l1, K1_L0):
                            ...
                            left_m1k1m0k0_l0 = isa.ldma_mov2lmb(
                                left_k1mk0_l1,
                                m_size_l1,
                                l0_m_start_in_l1,
                                l0_k1_start_in_l1,
                            ...
                            right_n1k1n0k0_l0 = isa.ldma_mov2rmb(
                                right_k1nk0_l1,
                                n_size_l1,
                                l0_n_start_in_l1,
                                l0_k1_start_in_l1,
                            ...
                            psum_en = not bias_en
                            result_m1n1m0n0_l0 = isa.mxu_matmul(
                                left_m1k1m0k0_l0,
                                right_n1k1n0k0_l0,
                                bias_n1n0_pmb,
                                result_m1n1m0n0_l0,
...
# Single-level tiled matmul from GM to LMB/RMB.
    ...
    for l0_n_start_in_l2 in range(0, N_L2, N_L0):
        ...
        for l0_m_start_in_l2 in range(0, M_L2, M_L0):
            ...
            for l0_k1_start_in_l2 in range(0, K1_L2, K1_L0):
                ...
                left_m1k1m0k0_l0 = isa.gdma_mov2lmb(
                    left_k1mk0_l2,
                    M_L2,
                    l0_m_start_in_l2,
                    K1_L2,
                ...
                right_n1k1n0k0_l0 = isa.gdma_mov2rmb(
                    right_k1nk0_l2,
                    N_L2,
                    l0_n_start_in_l2,
                    K1_L2,
...
# Matmul with right operand in KN layout (for QK^T style usage).
def op_matmul_transpose(left, right, bias):
    ...
    # Build [N1, K, N0] layout expected by ldma_mov2rmb_transpose.
